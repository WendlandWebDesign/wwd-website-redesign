...
<main>
    ...
    <div class="slider-holder">
        <div class="slider-bar mw-small">
            <p class="indikator mini-heading">Privatbrauerei Laase</p>
            <p class="indikator mini-heading">Schrotthandel Smit</p>
            <p class="indikator mini-heading">EFG Lüchow</p>
        </div>
            ...
            <div class="slider">
                ...
                <div class="slide">
                    ...
                    <div class="right">
                        <div class="txt-holder">
                            <p class="light slider-heading">Privatbrauerei Laase</p>
                            <p class="light">blabla bi bapo Kleine Übrschrift blabla bi bapo Kleine Übrschrift blabla bi bapo Kleine Übrschrift blabla bi bapo</p>
                            <button onclick="window.location.href='<?php echo esc_url( home_url( '/kontakt/' ) ); ?>'" class="btn light">
                                <span class="btn__border" aria-hidden="true">
                                    <svg class="btn__svg" viewBox="0 0 100 40" preserveAspectRatio="none">
                                        <path class="btn__path" d="M2,2 H98 Q100,2 100,4 V36 Q100,38 98,38 H2 Q0,38 0,36 V4 Q0,2 2,2 Z"/>
