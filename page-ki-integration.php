...
<?php include_once "assets/_snippets/hero.php" ?>
	...
	if ( $ki_query->have_posts() ) :
		while ( $ki_query->have_posts() ) :
			$ki_query->the_post();
			$post_id = get_the_ID();
		...
		if ( current_user_can( 'edit_posts' ) ) :
			?>
			<p class="mw-small"><?php echo esc_html( 'Kein CPT-Eintrag fuer "ki-integration" gefunden. Bitte einen Eintrag anlegen.' ); ?></p>
			<?php
		endif;
	endif;
	?>
