	...
	<div class="three-img-layout mw-small">
		...
		<?php if ( $img_2_url ) : ?>
			<div class="img-holder reveal">
				...
				<img src="<?php echo esc_url( $img_2_url ); ?>" alt="<?php echo esc_attr( $img_2_alt ); ?>" loading="lazy" decoding="async">
			</div>
		<?php endif; ?>
		<?php if ( $img_3_url ) : ?>
			<div class="img-holder reveal">
				<p class="mini-heading light"><?php echo esc_html( $t3 ); ?></p>
				<img src="<?php echo esc_url( $img_3_url ); ?>" alt="<?php echo esc_attr( $img_3_alt ); ?>" loading="lazy" decoding="async">
			</div>
		<?php endif; ?>
